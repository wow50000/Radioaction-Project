...
#define RACES_RESPECTED list(RACES_HUMANLIKE)

#define RACES_VERY_SHUNNED_UP list(RACES_SHUNNED, RACES_TOLERATED, RACES_VERY_SHUNNED, RACES_HUMANLIKE)

#define RACES_SHUNNED_UP list(RACES_SHUNNED, RACES_TOLERATED, RACES_HUMANLIKE)

#define RACES_TOLERATED_UP list(RACES_TOLERATED, RACES_HUMANLIKE)
