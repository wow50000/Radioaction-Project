...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_COMMIE = span_bloody("I can recognize other children of PSYDON, and they can recognize me too."),
	TRAIT_PSYDONITE = span_info("PSYDON guides me to other true followers."),
